package ukma.springboot.nextskill.modules.course.management;
...
import ukma.springboot.nextskill.modules.course.CourseInternalAPI;
import ukma.springboot.nextskill.modules.course.repository.CourseRepository;
...
import ukma.springboot.nextskill.modules.course.mapper.CourseMapper;
...
import ukma.springboot.nextskill.modules.course.validation.CourseValidator;
...
public class CourseManagement implements CourseInternalAPI, CourseExternalAPI {
    ...
    public void delete(UUID id) {
        UserResponse currentUser = userExternalAPI.getAuthenticatedUser();
